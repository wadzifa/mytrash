        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label>Wilayah</label>
                        <p class="form-control-static"><?php echo $row["wilayah"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Jenis Sampah</label>
                        <p class="form-control-static"><?php echo $row["jenis_sampah"]; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Berat Sampah</label>
                        <p class="form-control-static"><?php echo $row["berat_sampah"]; ?></p>
                    </div>
